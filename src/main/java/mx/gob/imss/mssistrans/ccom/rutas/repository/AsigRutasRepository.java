...
public interface AsigRutasRepository extends JpaRepository<AsigRutasEntity, Integer> {
    ...
    @Query(value = "SELECT SR.ID_RUTA, SR.NUM_FOLIO_RUTA AS NUM_FOLIO_RUTA, SCR.ID_SOLICITUD AS ID_SOLICITUD, SV.CVE_ECCO AS CVE_ECCO, "
            ...
            + " AND  REA.IND_SISTEMA = 1 "
            , nativeQuery = true)
    Page<List<AsigRutasEntity>> consultaGeneralRasignaciones(Pageable page);
    ...
    @Query(value = "SELECT SR.ID_RUTA, SR.NUM_FOLIO_RUTA AS NUM_FOLIO_RUTA, SCR.ID_SOLICITUD AS ID_SOLICITUD, SV.CVE_ECCO AS CVE_ECCO"
            ...
            + " AND SR.ID_RUTA = ? AND SCR.ID_SOLICITUD = ?"
            , nativeQuery = true)
    Page<List<AsigRutasEntity>> getConsultaByIdReasignaciones(String idAsignacion, String idSolicitud, Pageable pageable);
    ...
    @Query(value = "SELECT SR.ID_RUTA, SR.NUM_FOLIO_RUTA AS NUM_FOLIO_RUTA, SCR.ID_SOLICITUD AS ID_SOLICITUD, SV.CVE_ECCO AS CVE_ECCO"
            ...
            + " AND SR.ID_RUTA  = ? "
            , nativeQuery = true)
    Page<List<AsigRutasEntity>> getConsultaByIdAsignacionReasignaciones(String idRuta, Pageable pageable);
    ...
    @Query(value = "SELECT SR.ID_RUTA, SR.NUM_FOLIO_RUTA AS NUM_FOLIO_RUTA, SCR.ID_SOLICITUD AS ID_SOLICITUD, SV.CVE_ECCO AS CVE_ECCO"
            ...
            + " AND SCR.ID_SOLICITUD = ? "
            , nativeQuery = true)
Page<List<AsigRutasEntity>> getConsultaByIdSolicitudReasignaciones(String idSolicitud, Pageable pageable);
    ...
    @Modifying(flushAutomatically = true)
    @Query(value = "UPDATE SINTRANST_CONTROL_RUTAS SET CVE_MATRICULA_MODIFICA = ?, FEC_ACTUALIZACION = CURRENT_TIMESTAMP(), DES_ESTATUS_ASIGNA = '1' "
            ...
            , nativeQuery = true)
    void actalizarCOntrolRutasReasignacion(String cveMatriculaModifica, String idReasignacion);
