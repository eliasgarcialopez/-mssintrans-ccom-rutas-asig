...
public interface RegistroRecorridoRepository extends JpaRepository<RegistroRecorridoEntity, Integer> {
    ...
    @Query(value = "UPDATE SINTRANST_RUTAS_ASIGNACIONES SET TIM_HORA_INICIO_ASIGNACION = ?"
            ...
            , nativeQuery = true)
    void update(String horaInicioAsignacion, String idRuta1,
                String hrInicio1, String hrFin1, String idRuta2,
                String hrInicio2, String hrFin2, String idRuta3,
                String hrInicio3, String hrFin3, String estatusTraslado,
                String idVehiculo, String idRuta);
