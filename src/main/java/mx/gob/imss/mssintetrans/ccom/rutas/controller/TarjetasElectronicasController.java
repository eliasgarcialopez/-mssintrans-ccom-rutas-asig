package mx.gob.imss.mssintetrans.ccom.rutas.controller;
...
public class TarjetasElectronicasController {
	...
	/**
	 * Consultar las tarjetas de combustible disponibles por IdOOAD
	 *
	 * @param idOOAD
	 *
	 * @return
	 */
	@GetMapping
	public ResponseEntity<Respuesta<?>> consultarTarjetasCombustible(@RequestParam Integer idOOAD) {
	
	Respuesta<?> response =tarjetasElectronicasService.busquedaTarjetasDigitales(idOOAD);
